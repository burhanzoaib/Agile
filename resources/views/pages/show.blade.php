            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" value="{{$tourPackage->title}}" name="title" readonly required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="singleLineDetail">Single Line Details</label>
                        {!! $tourPackage->singleLineDetail !!}
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="totalDays" readonly value="{{$tourPackage->totalDays}}" name="totalDays" step="0.01" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="capacity">Capacity</label>
                        <input type="number" class="form-control" id="capacity" readonly value="{{$tourPackage->capacity}}" name="capacity" step="0.01" required>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ageRestriction" readonly value="{{$tourPackage->ageRestriction}}" name="ageRestriction" step="0.01" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="oldPrice">Old Price</label>
                        <input type="number" class="form-control" id="oldPrice" readonly value="{{$tourPackage->oldPrice}}" name="oldPrice" step="0.01">
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="newPrice" readonly value="{{$tourPackage->newPrice}}" name="newPrice" step="0.01" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="fromDate">From Date</label>
                        <input type="date" class="form-control" id="fromDate" readonly value="{{$tourPackage->fromDate}}" name="fromDate" required>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="promoCode" readonly value="{{$tourPackage->promoCode}}" name="promoCode" step="0.01" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="howManyPeople">How Many People</label>
                        <input type="number" class="form-control" id="howManyPeople" readonly value="{{$tourPackage->howManyPeople}}" name="howManyPeople" step="0.01" required>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        @if ($tourPackage->images)
                            <div id="current-images">
                                @foreach(json_decode($tourPackage->images) as $image)
...
{!! $tourPackage->meeting_point!!}</textarea>
</div>
</div>
<div class="col-md-6">
<div class="form-group">
<label for="important_information">Important Information</label>
{!! $tourPackage->important_information!!}
</div>
