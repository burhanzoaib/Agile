            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="ageRestriction" name="ageRestriction" step="0.01"
                        value="{{ old('ageRestriction') }}"  >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="newPrice" name="newPrice" step="0.01" value="{{ old('newPrice') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
