...
<div class="content-wrapper">
    ...
    <div class="container">
        ...
        @endif
        <form method="POST" action="{{ route('vip.update', $viptransportation->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @if($errors->any())
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="totalDays" value="{{$viptransportation->totalDays}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ageRestriction"
                            value="{{$viptransportation->ageRestriction}}" name="ageRestriction" step="0.01" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="oldPrice">Old Price</label>
                        <input type="number" class="form-control" id="oldPrice" value="{{$viptransportation->oldPrice}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="newPrice" value="{{$viptransportation->newPrice}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fromDate" value="{{$viptransportation->fromDate}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="howManyPeople "
                            value="{{$viptransportation->howManyPeople}}" name="howManyPeople" step="0.01">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="longDetail" name="longDetail"
                            required>{{$viptransportation->longDetail}}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="highlights" name="highlights" rows="3"
                            required>{{$viptransportation->highlights}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="full_decription" name="full_decription" rows="3"
                            required>{{$viptransportation->full_decription}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="includes" name="includes" rows="3"
                            required>{{$viptransportation->includes}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="not_suitable" name="not_suitable" rows="3"
                            required>{{$viptransportation->not_suitable}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="meeting_point" name="meeting_point" rows="3"
                            required>{{$viptransportation->meeting_point}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="important_information" name="important_information"
                            rows="3" required>{{$viptransportation->important_information}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="singleLineDetail" name="singleLineDetail" rows="3"
                            required>{{$viptransportation->singleLineDetail}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="position" class="form-control">
                            ...
                            <option value="1" {{ ($viptransportation->position == 1)? "selected":""  }}>1</option>
                            <option value="2"{{ ($viptransportation->position == 2)? "selected":""  }}>2</option>
                            <option value="3"{{ ($viptransportation->position == 3)? "selected":""  }}>3</option>
                            <option value="4"{{ ($viptransportation->position == 4)? "selected":""  }}>4</option>
                            <option value="5"{{ ($viptransportation->position == 5)? "selected":""  }}>5</option>
                        </select>
                    </div>
                </div>
        ...
        <div>
            ...
            <div class="row p-4">
                @foreach(json_decode($viptransportation->images) as $index => $image)
                <div id="current-images" class="col-md-3">
                    <img src="{{ $image }}" alt="Current Image" width="200px" height="150px">
                    <form method="POST"
                        action="{{ route('vip.delete-image', ['id' => $viptransportation->id, 'index' => $index]) }}">
                        @csrf
                        @method('DELETE')
