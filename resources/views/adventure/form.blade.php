            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="totalDays" name="totalDays" step="0.01"  value="{{ old('totalDays') }}"required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="ageRestriction" name="ageRestriction" step="0.01"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        value="{{ old('howManyPeople') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
