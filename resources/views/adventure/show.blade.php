        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="totalDays" readonly value="{{$adventure->totalDays}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ageRestriction" readonly
                        value="{{$adventure->ageRestriction}}" name="ageRestriction" step="0.01" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="oldPrice">Old Price</label>
                    <input type="number" class="form-control" id="oldPrice" readonly value="{{$adventure->oldPrice}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="newPrice" readonly value="{{$adventure->newPrice}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fromDate" readonly value="{{$adventure->fromDate}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="position" readonly value="{{$adventure->position}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="howManyPeople" readonly
                        value="{{$adventure->howManyPeople}}" name="howManyPeople" step="0.01" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="longDetail">Long Details</label>
                    {!! $adventure->longDetail !!}
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! $adventure->important_information !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="singleLineDetail">Single Line Details</label>
                    {!! $adventure->singleLineDetail !!}
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div id="current-images" class="col-md-6">
                            @foreach(json_decode($adventure->images) as $image)
                            <img src="{{ $image }}" height="100px" width="100px" alt="Current Image"
