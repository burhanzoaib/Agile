...
<div class="content-wrapper">
    ...
    <div class="row">
                <div class="col">
                    <h3 class="page-title fw-bold">Add user</h3>
                </div>
            </div>
            <div class="container">
                @if($errors->any())
            ...
            <form method="POST" action="{{ route('user.user_update',$user->id) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" value="{{ $user->email  }}" readonly name="email" >
