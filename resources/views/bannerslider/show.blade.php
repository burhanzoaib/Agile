...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="bannername" value="{{ $bannerslider->bannername }}" name="bannername" readonly required>
        </div>
    </div>
    <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if ($bannerslider->images)
                            <div id="current-images">
                                @foreach(json_decode($bannerslider->images) as $image)
