...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="userid" value="{{ $review->user_id }}" name="userid" readonly required>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="activity_id">Activity Id</label>
            <input type="text" class="form-control" value="{{ $review->activity_id }}" name="activity_id" readonly required>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="activity_type" value="{{ $review->activity_type }}" name="activity_type" readonly required>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="link">Reviews</label>
            <input type="text" class="form-control" value="{{ $review->review }}" name="review" readonly required>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" value="{{ $review->rating }}" name="name" readonly required>
        </div>
    </div>
    <div class="col-md-6">
