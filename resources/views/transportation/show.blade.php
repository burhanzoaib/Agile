        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="totalDays" readonly value="{{$transportation->totalDays}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ageRestriction" readonly
                        value="{{$transportation->ageRestriction}}" name="ageRestriction" step="0.01" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="oldPrice">Old Price</label>
                    <input type="number" class="form-control" id="oldPrice" readonly value="{{$transportation->oldPrice}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="newPrice" readonly value="{{$transportation->newPrice}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fromDate" readonly value="{{$transportation->fromDate}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="position" readonly value="{{$transportation->position}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="howManyPeople" readonly
                        value="{{$transportation->howManyPeople}}" name="howManyPeople" step="0.01" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="longDetail">Long Details</label>
                    {!! $transportation->longDetail !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! $transportation->full_decription !!}
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div id="current-images">
                        @foreach(json_decode($transportation->images) as $image)
