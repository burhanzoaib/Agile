            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="title">Transportation Title</label>
                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="totalDays">Total Days / Hours</label>
                        <input type="text" class="form-control" id="totalDays" name="totalDays" value="{{ old('totalDays') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
...
{{--                        <input type="number" class="form-control" id="capacity" name="capacity" value="{{ old('capacity') }}" step="0.01" required>--}}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="ageRestriction">Age Restriction</label>
                        <input type="number" class="form-control" id="ageRestriction" name="ageRestriction" value="{{ old('ageRestriction') }}" step="0.01">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="oldPrice">Old Price</label>
                        <input type="number" class="form-control" id="oldPrice" name="oldPrice" value="{{ old('oldPrice') }}" step="0.01">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fromDate" name="fromDate" value="{{ old('fromDate') }}" required>
                    </div>
                </div>
                <!-- <div class="col-md-6">
                    <div class="form-group">
                        <label for="promoCode">Promo Code</label>
                        <input type="text" class="form-control" id="promoCode" name="promoCode" value="{{ old('promoCode') }}" step="0.01" required>
                    </div>
                </div> -->
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="howManyPeople">Minimum People</label>
                        <input type="number" class="form-control" id="howManyPeople" value="{{ old('howManyPeople') }}" name="howManyPeople" step="0.01">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="highlights" name="highlights" value="" rows="3"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control ckeditor" id="package_id" name="important_information" rows="3"
                            hidden>
            ...
            <div class="row">
                ...
                <div class="form-group">
                <label>Time</label>
                <input type="time" name="ava_time[]" class="form-control" value="{{ old('ava_time[]') }}">
            </div>
                </div>
