...
<div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @if (isset($booking->attraction->images) && !empty(json_decode($booking->attraction->images)))

                        <div id="current-images">

                            @foreach(json_decode($booking->attraction->images) as $image)
            ...
            <div class="form-group">
                ...
                <input class="form-control" readonly value="{{ $booking->attraction->title ?? 'N/A' }}" required>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! isset($booking->attraction->longDetail) ? $booking->attraction->longDetail : 'N/A' !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="oldPrice">Single Line Detail</label>
            {!! isset($booking->attraction->singleLineDetail) ? $booking->attraction->singleLineDetail : 'N/A' !!}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" readonly value="{{ $booking->attraction->title ?? 'null' }}" required>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="Package_id">howManyPeople</label>
            <input class="form-control" readonly value="{{ $booking->attraction->howManyPeople ?? 'null' }}" required>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" readonly value="{{ $booking->attraction->totalDays ?? 'null' }}" required>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="Package_id">Capacity</label>
            <input class="form-control" readonly value="{{ $booking->attraction->capacity ?? 'null' }}" required>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" readonly value="{{ $booking->attraction->ageRestriction ?? 'null' }}" required>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="Package_id">From Date</label>
            <input class="form-control" readonly value="{{ $booking->attraction->fromDate ?? 'null' }}" required>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" readonly value="{{ $booking->attraction->oldPrice ?? 'null' }}" >
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="Package_id">New Price</label>
            <input class="form-control" readonly value="{{ $booking->attraction->newPrice ?? 'null' }}" required>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! isset($booking->attraction->highlights) ? $booking->attraction->highlights : 'N/A' !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="Package_id">Full Description</label>
            {!! isset($booking->attraction->full_decription) ? $booking->attraction->full_decription : 'N/A' !!}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! isset($booking->attraction->includes) ? $booking->attraction->includes : 'N/A' !!}
        </div>
    </div>
    <div class="col-md-6">
    <div class="form-group">
        <label for="Package_id">Not Suitable</label>
        {!! isset($booking->attraction->not_suitable) ? $booking->attraction->not_suitable : 'N/A' !!}
    </div>
</div>
</div>
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! isset($booking->attraction->meeting_point) ? $booking->attraction->meeting_point : 'N/A' !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label for="Package_id">Important Information</label>
            {!! isset($booking->attraction->important_information) ? $booking->attraction->important_information : 'N/A' !!}
        </div>
    </div>
</div>
<div class="row">
