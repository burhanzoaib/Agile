...
<div class="content-wrapper">
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('city.update', $tourPackage->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @if($errors->any())
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" value="{{$tourPackage->title}}" name="title"
                            required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="totalDays" value="{{$tourPackage->totalDays}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="tour_type_section">
                            ...
                            <option {{ ($tourPackage->tour_type_section == "Private Tour" )? "Selected":"" }}  >Private Tour</option>
                            <option {{ ($tourPackage->tour_type_section == "Group Tour" )? "Selected":"" }} >Group Tour</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="ageRestriction"
                            value="{{$tourPackage->ageRestriction}}" name="ageRestriction" step="0.01">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="oldPrice">Old Price</label>
                        <input type="number" class="form-control" id="oldPrice" value="{{$tourPackage->oldPrice}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="newPrice" value="{{$tourPackage->newPrice}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="fromDate" value="{{$tourPackage->fromDate}}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="howManyPeople "
                            value="{{$tourPackage->howManyPeople}}" name="howManyPeople" step="0.01">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="longDetail" name="longDetail"
                            required>{{$tourPackage->longDetail}}</textarea>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="highlights" name="highlights" rows="3"
                            required>{{$tourPackage->highlights}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="full_decription" name="full_decription" rows="3"
                            required>{{$tourPackage->full_decription}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="includes" name="includes" rows="3"
                            required>{{$tourPackage->includes}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="not_suitable" name="not_suitable" rows="3"
                            required>{{$tourPackage->not_suitable}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="meeting_point" name="meeting_point" rows="3"
                            required>{{$tourPackage->meeting_point}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="important_information" name="important_information"
                            rows="3" required>{{$tourPackage->important_information}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" id="singleLineDetail" name="singleLineDetail" rows="3"
                            required>{{$tourPackage->singleLineDetail}}</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        @foreach($tourPackage->time as $item)
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="position" class="form-control">
                            ...
                            <option value="1"{{ ($tourPackage->position == 1)? "selected":""  }}>1</option>
                            <option value="2"{{ ($tourPackage->position == 2)? "selected":""  }}>2</option>
                            <option value="3"{{ ($tourPackage->position == 3)? "selected":""  }}>3</option>
                            <option value="4"{{ ($tourPackage->position == 4)? "selected":""  }}>4</option>
                            <option value="5"{{ ($tourPackage->position == 5)? "selected":""  }}>5</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div id="current-images" class="col-md-6 p-2">
                            @if (isset($tourPackage->front_images) && !empty(json_decode($tourPackage->front_images)))
                            @foreach (json_decode($tourPackage->front_images) as $image)
        ...
        <div>
            <h3 >Images</h3>
            @if (isset($tourPackage->images) && !empty(json_decode($tourPackage->images)))
            <div class="row">
                @foreach(json_decode($tourPackage->images) as $index => $image)
                <div id="current-images" class="col-md-3">
                    <img src="{{ $image }}" alt="Current Image" width="200px" height="150px">
                    <form method="POST"
                        action="{{ route('city.delete-image', ['id' => $tourPackage->id, 'index' => $index]) }}">
                        @csrf
                        @method('DELETE')
