        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="totalDays" readonly value="{{$tourPackage->totalDays}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ageRestriction" readonly
                        value="{{$tourPackage->ageRestriction}}" name="ageRestriction" step="0.01" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="oldPrice">Old Price</label>
                    <input type="number" class="form-control" id="oldPrice" readonly value="{{$tourPackage->oldPrice}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="newPrice" readonly value="{{$tourPackage->newPrice}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fromDate" readonly value="{{$tourPackage->fromDate}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="position" readonly value="{{$tourPackage->position}}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="howManyPeople" readonly
                        value="{{$tourPackage->howManyPeople}}" name="howManyPeople" step="0.01" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
